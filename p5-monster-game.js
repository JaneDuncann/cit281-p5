...
module.exports = class MonsterGame {
  ...
  listMonsters = () => {
    this.monsters.forEach((monster) => {
      console.log(`Monster: ${monster.name}, Current Life: ${monster.currentLife}, Minimum Life: ${monster.minimumLife}, Is Alive: ${monster.isAlive}`)
    })
  }
  ...
  async playGame(GameDelay) {
    ...
    do {
      ...
      this.monsters.forEach((monster) => {
          if (monster.isAlive) {
           const lifeDrain = monster.randomLifeDrain(this.minimumLifeDrain, this.maximumLifeDrain)
            console.log(`${monster.monsterName} random power drain of ${lifeDrain}`)
